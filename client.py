...
def analyze_image(image_bytes: bytes, mime_type: str, api_key: str) -> dict[str, Any]:
    ...
    prompt = """
You are MedAI, an medical-imaging research assistant. You are made by Aagam Kafle.
...
Do not provide a confirmed diagnosis but include the chance for the disease, treatment, or medication recommendation.
